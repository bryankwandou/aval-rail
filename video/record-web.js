...
// — including the refusals. If the daemon were down, this recording would show
...
const OUT = path.join(__dirname, 'out-web');
...
(async () => {
  ...
  // daemon's own /health — so the uptime on screen is the process's, not a badge.
